...
from functionary.prompt_template.base_template_31 import PromptTemplate
...
class Llama31Template(PromptTemplate):
    ...
    def convert_message_to_prompt(self, message: Dict) -> str:
        ...
        for tool_call in tool_calls:
            ...
            arguments = json.dumps(json.loads(arguments), ensure_ascii=False)  ## As agent langchain openai use json.dumps(ensure_ascii=True), dumps, loads again
